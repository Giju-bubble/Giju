...
INSERT IGNORE INTO reviews (user_id, drink_id, order_id, image_id, content, score)
VALUES
    ...
    (UUID_TO_BIN( '11111111-1111-1111-1111-111111111112'), 44, 3, NULL, '전주이강주는 역시 명불허전이네요! 배와 생강의 조화가 환상적이고, 25도인데도 목넘김이 너무 부드러워요. 가격은 좀 비싸지만 그만한 가치가 있습니다.', 5),
    (UUID_TO_BIN( '11111111-1111-1111-1111-111111111112'), 41, 4, NULL, '안동소주 일품 정말 깔끔하네요. 45도라 독하긴 하지만 뒷맛이 깨끗해서 좋았어요. 안주 없이도 마실 수 있을 정도입니다.', 4),
    (UUID_TO_BIN( '11111111-1111-1111-1111-111111111112'), 81, 5, NULL, '복분자주 선운은 달콤하면서도 상큼해서 여자분들이 좋아할 것 같아요. 도수도 적당하고 마시기 편해요.', 4),
    (UUID_TO_BIN( '11111111-1111-1111-1111-111111111112'), 45, 6, NULL, '황금보리소주는 보리 특유의 구수한 맛이 일품이에요. 40도 치고는 목�넘김이 부드럽고 향도 좋습니다.', 4),
    (UUID_TO_BIN( '11111111-1111-1111-1111-111111111112'), 21, 7, NULL, '맑은술 해밀 정말 깔끔하고 좋네요. 15도 정도라 부담스럽지 않고 식사와 함께 마시기 좋았어요.', 5),
...
VALUES
    ...
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222222'), 22, 13, NULL, '동학1957은 역사적 의미도 있고 맛도 훌륭해요. 16도 청주치고는 부드럽고 깔끔한 마무리가 인상적입니다.', 4),
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222222'), 42, 14, NULL, '문배술 정말 특별한 맛이에요. 40도라 독하지만 문배 향이 독특하고 전통주의 깊은 맛을 느낄 수 있었어요.', 5),
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222222'), 82, 15, NULL, '덕유양조 산머루주는 산머루 특유의 신맛과 단맛이 조화롭네요. 16도라 적당하고 색깔도 예뻐요.', 4),
...
VALUES
    ...
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222223'), 13, 21, NULL, '천비향은 경상북도 명주답게 향과 맛이 모두 훌륭해요. 8.5도로 적당하고 뒷맛이 깔끔합니다.', 5),
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222223'), 14, 22, NULL, '지란지교 정말 좋네요. 전라남도 전통주의 깊은 맛을 느낄 수 있었고, 8도라 마시기 편했어요.', 4),
...
VALUES
    ...
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222224'), 69, 27, NULL, '산삼약주는 가격이 비싸긴 하지만 건강에 좋고 맛도 깔끔해요. 18도치고는 부드럽고 산삼 향이 은은합니다.', 4),
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222224'), 92, 28, NULL, '샤토미소 와인 정말 놀랐어요. 한국산 와인인데 이렇게 맛있을 줄 몰랐습니다. 13.5도로 적당하고 깊은 맛이 있어요.', 5),
    (UUID_TO_BIN('22222222-2222-2222-2222-222222222224'), 103, 29, NULL, '비왈츠 로지는 독특한 리큐르네요. 12도로 마시기 편하고 디저트와 함께 마시면 더 좋을 것 같아요.', 3),
